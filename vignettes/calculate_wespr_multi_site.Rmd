---
title: "calculate_wespr_multi_site"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{calculate_wespr_multi_site}
...
We can calculate WESP-BC scores and ratings for multiple sites at once. Using the example data within the wespr packge we can firstly load the data, generate IDs and then calculate the raw values. 
...
We can also assign jenks (normalized) scores for each site. It is assumed that all sites are located within the same ecoprovince. 
